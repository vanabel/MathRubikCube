...
**基本概念**
- → [ENCODING_REFERENCE.md](ENCODING_REFERENCE.md)（编码系统）
- → [POSITION_VS_ORIENTATION.md](POSITION_VS_ORIENTATION.md)（位置vs朝向）
...
**可视化**
- → [VISUALIZATION_GUIDE.md](VISUALIZATION_GUIDE.md)（完整指南）
- → [INTERACTIVE_GUI_GUIDE.md](INTERACTIVE_GUI_GUIDE.md)（GUI使用）

**朝向功能**
- → [ENCODING_REFERENCE.md](ENCODING_REFERENCE.md)第三节（朝向编码）
- → [POSITION_VS_ORIENTATION.md](POSITION_VS_ORIENTATION.md)（概念解释）
...
1. **[POSITION_VS_ORIENTATION.md](POSITION_VS_ORIENTATION.md)** - 理解核心概念
2. **[MOVES_REFERENCE.md](MOVES_REFERENCE.md)** - 掌握所有操作
3. **[VISUALIZATION_GUIDE.md](VISUALIZATION_GUIDE.md)** - 学会可视化工具

### 问题排查

1. 安装问题 → **[INSTALL_MATPLOTLIB.md](INSTALL_MATPLOTLIB.md)**
2. 字体问题 → **[FONT_FIX.md](FONT_FIX.md)**
3. 公式验证 → `python verify_formula.py`
4. 理解错误 → **[POSITION_VS_ORIENTATION.md](POSITION_VS_ORIENTATION.md)**
...
- [ ] 阅读 [ENCODING_REFERENCE.md](ENCODING_REFERENCE.md) 第3-5节（朝向和操作）
- [ ] 阅读 [POSITION_VS_ORIENTATION.md](POSITION_VS_ORIENTATION.md)
- [ ] 阅读 [MOVES_REFERENCE.md](MOVES_REFERENCE.md)
- [ ] 在GUI中测试各种公式
- [ ] 理解交换子和循环
...
1. ⭐ **[ENCODING_REFERENCE.md](ENCODING_REFERENCE.md)** - 编码系统完整参考
2. **[../README.md](../README.md)** - 项目总览
3. **[POSITION_VS_ORIENTATION.md](POSITION_VS_ORIENTATION.md)** - 核心概念
